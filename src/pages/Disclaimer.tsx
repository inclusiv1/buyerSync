    ...
    <main className="editorial-container py-12 md:py-20">
      <article className="mx-auto max-w-4xl">
        ...
        <p className="mt-8 border-l-2 border-primary pl-5 text-base leading-7">
          Please read this page before using Home Buyer Sync. By accessing or using the site, you acknowledge these terms and disclosures. If you do not agree, do not use the site.
        </p>
        ...
        <div className="mt-12 space-y-10 text-sm leading-7 text-muted-foreground [&_h2]:mb-3 [&_h2]:text-3xl [&_h2]:text-foreground [&_h3]:mb-2 [&_h3]:mt-5 [&_h3]:font-sans [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:tracking-normal [&_h3]:text-foreground [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
          ...
          <section>
            ...
            <p>Depending on how you use the site, Home Buyer Sync may collect or store:</p>
            <ul className="mt-3">
            ...
            <p className="mt-3">Credit score, income, and debt values entered into the financing calculator are used in your browser to produce estimates and are not saved by Home Buyer Sync. Do not enter sensitive personal, financial, health, or confidential information into free-text fields.</p>
          </section>
          ...
          <section>
            ...
            <p>You retain responsibility for content you submit. You confirm that you have the necessary rights and permissions to upload, share, and use it. You grant Home Buyer Sync a non-exclusive license to host, reproduce, process, and display that content only as needed to operate, secure, and improve the service. Do not upload unlawful, misleading, infringing, confidential, malicious, or harmful material.</p>
          </section>

          <section>
            <h2>Third-party links, listings, and advertisements</h2>
            <p>Links, imported content, advertisements, and references to third parties do not constitute endorsement or a guarantee. Home Buyer Sync does not control third-party availability, accuracy, security, products, services, transactions, or privacy practices. Your interactions with a property source, professional, advertiser, lender, government program, or other third party are solely between you and that party.</p>
          </section>

          <section>
            <h2>Availability, warranties, and limitation of liability</h2>
            <p>To the fullest extent permitted by law, the site is provided “as is” and “as available,” without warranties of accuracy, availability, merchantability, fitness for a particular purpose, title, or non-infringement. Home Buyer Sync does not guarantee that the service will be uninterrupted, error-free, secure, or suitable for a particular transaction.</p>
            <p className="mt-3">To the fullest extent permitted by law, Home Buyer Sync and its operators will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, lost data, lost profits, lost opportunities, property decisions, financing outcomes, or reliance on site content. Some jurisdictions do not allow certain exclusions, so portions of this section may not apply to you. Your non-waivable consumer rights remain unaffected.</p>
          </section>

          <section>
            <h2>Children and geographic availability</h2>
            <p>The site is intended for adults and is not directed to children under 13. Do not submit a child’s personal information. Home Buyer Sync may not be appropriate or available in every location, and users are responsible for following the laws that apply where they live and where a property is located.</p>
          </section>
