  ...
  return (
    <div className="editorial-shell flex min-h-screen items-center justify-center p-5">
      <Card className="w-full max-w-lg bg-background/90">
        <CardHeader><p className="eyebrow">Home Buyer Sync partners</p><CardTitle className="text-4xl">Create an advertiser account</CardTitle><p className="text-sm text-muted-foreground">Submit brand-safe campaigns for manual review and invoicing.</p></CardHeader>
