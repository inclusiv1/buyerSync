    ...
    <div className="grid min-h-screen bg-background lg:grid-cols-[1.15fr_0.85fr]">
      ...
      >
        <div className="flex items-center justify-between text-white">
          <div className="font-serif text-3xl">Home Buyer Sync</div>
      ...
      <div className="absolute inset-x-5 top-5 h-28 bg-cover bg-center lg:hidden" style={{ backgroundImage: "linear-gradient(90deg, rgba(28,31,26,.2), rgba(28,31,26,.65)), url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=900&q=80')" }}><span className="absolute bottom-4 left-4 font-serif text-2xl text-white">Home Buyer Sync</span></div>
      <Card className="w-full max-w-md border-0 bg-transparent shadow-none">
        <CardHeader className="px-0">
          ...
          <div className="mt-4 flex gap-3 border border-primary/20 bg-primary/5 p-4 text-sm leading-6">
            ...
            <p><span className="font-semibold text-foreground">Home Buyer Sync is completely free.</span> There are no paid plans, subscriptions, credit card requirements, or charges after signup.</p>
          </div>
        </CardHeader>
        <CardContent>
          <Form {...form}>
