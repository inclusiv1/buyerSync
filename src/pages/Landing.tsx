  ...
  <div className="landing-page min-h-screen overflow-hidden bg-background">
    <header className="absolute inset-x-0 top-0 z-30 border-b border-white/20 text-white">
      <div className="editorial-container flex h-20 items-center justify-between">
        <Link to="/" className="font-serif text-3xl font-medium">BuyerSync</Link>
    ...
    <main>
      <section className="landing-hero flex min-h-[46rem] items-end text-white md:min-h-screen">
        <div className="editorial-container pb-16 pt-36 md:pb-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-white/82 md:text-lg">BuyerSync brings listings, notes, scores, and the people you trust into one thoughtful home search—from the first favorite to the front-door keys.</p>
      ...
      <section className="editorial-container py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
          <div>
            <p className="eyebrow">Why BuyerSync</p>
            <h2 className="mt-4 font-serif text-5xl leading-[0.95] md:text-6xl">A shared place for a life-changing choice.</h2>
            <p className="mt-6 max-w-md text-sm leading-7 text-muted-foreground">Home buying gets complicated when links, reactions, and priorities live in different places. BuyerSync keeps the whole conversation together.</p>
          </div>
      ...
      <section className="editorial-container py-20 md:py-28">
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-7 text-muted-foreground">Everyone gets room to form an honest opinion, then BuyerSync makes the common ground visible. Keep your search organized, understand each other’s priorities, and spend more time imagining life in the right home.</p>
      ...
      <section className="landing-cta mx-5 mb-5 flex min-h-[32rem] items-center justify-center px-6 py-20 text-center text-white md:mx-10 md:mb-10">
        <div className="max-w-2xl">
          ...
          <p className="mx-auto mt-5 max-w-lg text-sm leading-6 text-white/75">Create your completely free BuyerSync account and turn your home search into one shared, confident decision. There is nothing to purchase after signup.</p>
    ...
    <footer className="editorial-container flex flex-col gap-4 py-8 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
      <span className="font-serif text-xl text-foreground">BuyerSync</span>
      <span>Home decisions, made together.</span>
      <div className="flex gap-5"><Link to="/login" className="hover:text-foreground">Sign in</Link><Link to="/advertise/signup" className="hover:text-foreground">Advertise</Link></div>
    </footer>
  </div>
);
